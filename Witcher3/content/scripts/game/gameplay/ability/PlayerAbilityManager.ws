...
class W3PlayerAbilityManager extends W3AbilityManager
{
	...
	private			var orgTotalSkillSlotsCount : int;							//original amount of skill slots (Elys) Triangle passive skills TODO how does this interact with new mutation
	...
	public final function Init(ownr : CActor, cStats : CCharacterStats, isFromLoad : bool, diff : EDifficultyMode) : bool
	{
		...
		orgTotalSkillSlotsCount = 12; // Triangle TODO cant hardcode with mutation!
