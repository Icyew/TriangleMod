...
function TOpts_GetLvlResistances(enemyBonusType : name, out dmgResist : float, out magicResist : float)
{
	switch (enemyBonusType) {
		case theGame.params.ENEMY_BONUS_PER_LEVEL:
			dmgResist = StringToFloat( theGame.GetInGameConfigWrapper().GetVarValue('TModOptionScaling', 'NPCDmgResistLvlBonus' ) );
			magicResist = StringToFloat( theGame.GetInGameConfigWrapper().GetVarValue('TModOptionScaling', 'NPCMagicResistLvlBonus' ) );
		case theGame.params.MONSTER_BONUS_PER_LEVEL_GROUP_ARMORED:
			dmgResist = StringToFloat( theGame.GetInGameConfigWrapper().GetVarValue('TModOptionScaling', 'GroupArmoredDmgResistLvlBonus' ) );
			magicResist = StringToFloat( theGame.GetInGameConfigWrapper().GetVarValue('TModOptionScaling', 'GroupArmoredMagicResistLvlBonus' ) );
		case theGame.params.MONSTER_BONUS_PER_LEVEL_ARMORED:
			dmgResist = StringToFloat( theGame.GetInGameConfigWrapper().GetVarValue('TModOptionScaling', 'ArmoredDmgResistLvlBonus' ) );
			magicResist = StringToFloat( theGame.GetInGameConfigWrapper().GetVarValue('TModOptionScaling', 'ArmoredMagicResistLvlBonus' ) );
		case theGame.params.MONSTER_BONUS_PER_LEVEL_GROUP:
			dmgResist = StringToFloat( theGame.GetInGameConfigWrapper().GetVarValue('TModOptionScaling', 'GroupDmgResistLvlBonus' ) );
			magicResist = StringToFloat( theGame.GetInGameConfigWrapper().GetVarValue('TModOptionScaling', 'GroupMagicResistLvlBonus' ) );
		case theGame.params.MONSTER_BONUS_PER_LEVEL:
			dmgResist = StringToFloat( theGame.GetInGameConfigWrapper().GetVarValue('TModOptionScaling', 'MonsterDmgResistLvlBonus' ) );
			magicResist = StringToFloat( theGame.GetInGameConfigWrapper().GetVarValue('TModOptionScaling', 'MonsterMagicResistLvlBonus' ) );
	}
}
