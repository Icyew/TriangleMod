...
statemachine import class CNewNPC extends CActor
{
	...
	event OnAardHit( sign : W3AardProjectile )
	{
		...
		if (TUtil_IsCustomSkillEnabled(S_Magic_s20) && sign.GetOwner().GetPlayer() && sign.GetOwner().GetPlayer().CanUseSkill(S_Magic_s20))
			DrainStamina(ESAT_FixedValue, GetStatMax(BCS_Stamina), TUtil_ValueForLevel(S_Magic_s20, TOpts_AardStaminaDelay()));
		// Triangle end
