...
{
	//public var dontShowEquipped:bool; default dontShowEquipped = false; //modSigns: moved to base
	public var syncWithPlayer : bool; default syncWithPlayer = false; //modSigns
	public var playerTabIndex : int; default playerTabIndex = -1; //modSigns
	...
	protected function ShouldShowItem( item : SItemUniqueId ) : bool
	{
		...
		}*/ //modSigns: moved to base
		
		if( syncWithPlayer && playerTabIndex != -1 ) //modSigns
		{
	...
	function GetTabForItem( item : SItemUniqueId ) : int //modSigns
	{
