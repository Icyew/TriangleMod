...
{	
	...
	// SKILLS
	private 			var fastAttackCounter, heavyAttackCounter, signAttackCounter	: int;		// Triangle attack combos //counter for light/heavy attacks. Currently not used but I leave it in case it will come back
